...
public class CashPaymentGUI extends javax.swing.JFrame {
    ...
    private void tfCashGivenActionPerformed(java.awt.event.ActionEvent evt) {                                            
        int num;
        try {
            num = Integer.parseInt(tfCashGiven.getText());
            String changeText;
         //String amountDue;
            double change = 0;
    ...
    private void btnCompleteTransActionPerformed(java.awt.event.ActionEvent evt) {                                                 
    try{
